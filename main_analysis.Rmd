...
The results estimate that the effect of `r pfas_type` on birth weight changes by `r round(coef(rma_ga)["GA"], 4)` g per unit increase in mean/median/midpoint gestational age at sample timing.
...
# Chemical-Specific Sensitivity Analyses

This section includes sensitivity analyses appropriate for the collection of `r pfas_type` studies only. 
