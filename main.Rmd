...
Results indicate that dropping `r loo$Study[ind]` leads to the lowest I2, `r loo$I2[ind]`%. However, the difference between this and the overall $I^2$  is negligible; so we proceed with `r loo$Study[ind]` included. 
...
# Run fixed effect model with strata as moderator; rma() runs an omnibus test 
