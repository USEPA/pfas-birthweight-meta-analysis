...
# Save p-value from hypothesis test differences across moderators (rma() runs an omnibus test for moderator variable, i.e., test for any differences across strata)
p1 <- round(res1$QMp, 4)
```
